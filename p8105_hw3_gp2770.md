...
![](p8105_hw3_gp2770_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
Loading, cleaning and tidying the demographic data. Data is encoded with
...
Merging the two datasets and excluding participants less than 21 years
of age and those with missing demographic data.
...
![](p8105_hw3_gp2770_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
Plotting total activities against age; comparing men to women and having
separate panels for each education level.
...
A three-panel plot showing 24-hour activity time courses for each
education level.
...
including the number of rides originating from these stations.
...
A plot to investigate the effects of day of the week, month, and year on
...
Impact of month, membership status, and bike type on the distribution of
ride duration (2024 Data)
